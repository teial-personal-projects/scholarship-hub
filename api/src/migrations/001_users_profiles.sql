...
-- This migration creates the user profiles and roles tables
...
-- Users can insert their own roles (e.g., when signing up or adding a new role)
...
BEGIN
  ...
  -- Assign default 'student' role linked to auth.users
